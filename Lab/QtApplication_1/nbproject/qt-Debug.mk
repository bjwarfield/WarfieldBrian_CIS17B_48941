#############################################################################
# Makefile for building: QtApplication_1
...
ZIP           = 
DEF_FILE      = 
RES_FILE      = build/Debug/MinGW_Qt-Windows/QtApplication_1_resource_res.o
COPY          = cp -f
SED           = sed
COPY_FILE     = cp -f
COPY_DIR      = cp -f -R
...
OBJECTS       = build/Debug/MinGW_Qt-Windows/QtApplication_1_resource_res.o \
		build/Debug/MinGW_Qt-Windows/HelloForm.o \
		build/Debug/MinGW_Qt-Windows/main.o \
		build/Debug/MinGW_Qt-Windows/moc_HelloForm.o
...
TARGET         = QtApplication_1.exe
DESTDIR_TARGET = dist/Debug/MinGW_Qt-Windows/QtApplication_1.exe
...
$(DESTDIR_TARGET): ui_HelloForm.h $(OBJECTS) build/Debug/MinGW_Qt-Windows/QtApplication_1_resource_res.o
	$(LINKER) $(LFLAGS) -o $(DESTDIR_TARGET) $(OBJECTS)  $(LIBS)

build/Debug/MinGW_Qt-Windows/QtApplication_1_resource_res.o: QtApplication_1_resource.rc
	windres -i QtApplication_1_resource.rc -o build/Debug/MinGW_Qt-Windows/QtApplication_1_resource_res.o --include-dir=. $(DEFINES)
...
ui_HelloForm.h: HelloForm.ui
	/C/Developer/msys64/mingw64/bin/uic.exe HelloForm.ui -o ui_HelloForm.h
...
build/Debug/MinGW_Qt-Windows/HelloForm.o: HelloForm.cpp HelloForm.h \
		ui_HelloForm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW_Qt-Windows/HelloForm.o HelloForm.cpp

build/Debug/MinGW_Qt-Windows/main.o: main.cpp HelloForm.h \
		ui_HelloForm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW_Qt-Windows/main.o main.cpp

build/Debug/MinGW_Qt-Windows/moc_HelloForm.o: moc_HelloForm.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/MinGW_Qt-Windows/moc_HelloForm.o moc_HelloForm.cpp
