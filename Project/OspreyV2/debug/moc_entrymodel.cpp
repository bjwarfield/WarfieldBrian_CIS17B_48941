...
QT_MOC_LITERAL(1, 11, 9), // "entryPath"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 15), // "QVector<Point>*"
QT_MOC_LITERAL(4, 38, 5), // "paths"
QT_MOC_LITERAL(5, 44, 8), // "entryRow"
QT_MOC_LITERAL(6, 53, 7), // "current"
QT_MOC_LITERAL(7, 61, 8) // "previous"

    },
    "EntryModel\0entryPath\0\0QVector<Point>*\0"
    "paths\0entryRow\0current\0previous"
};
...
void EntryModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->entryPath((*reinterpret_cast< QVector<Point>*(*)>(_a[1]))); break;
        case 1: _t->entryRow((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< const QModelIndex(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (EntryModel::*_t)(QVector<Point> * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EntryModel::entryPath)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void EntryModel::entryPath(QVector<Point> * _t1)
{
