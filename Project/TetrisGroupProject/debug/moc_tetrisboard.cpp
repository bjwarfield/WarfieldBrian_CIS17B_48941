...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TetrisBoard_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TetrisBoard_t qt_meta_stringdata_TetrisBoard = {
    {
QT_MOC_LITERAL(0, 0, 11), // "TetrisBoard"
...
QT_MOC_LITERAL(9, 86, 5) // "pause"
    ...
    "TetrisBoard\0scoreChanged\0\0score\0"
    "levelChanged\0level\0linesRemovedChanged\0"
    "numLines\0start\0pause"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_TetrisBoard[] = {
...
void TetrisBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TetrisBoard *_t = static_cast<TetrisBoard *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TetrisBoard::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TetrisBoard::scoreChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (TetrisBoard::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TetrisBoard::levelChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (TetrisBoard::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TetrisBoard::linesRemovedChanged)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject TetrisBoard::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_TetrisBoard.data,
      qt_meta_data_TetrisBoard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TetrisBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TetrisBoard.stringdata0))
        return static_cast<void*>(const_cast< TetrisBoard*>(this));
...
// SIGNAL 0
void TetrisBoard::scoreChanged(int _t1)
{
...
// SIGNAL 1
void TetrisBoard::levelChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void TetrisBoard::linesRemovedChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
